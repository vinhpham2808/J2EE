...
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-[#0A0E1A] text-slate-900 dark:text-slate-100 font-['Inter',sans-serif] antialiased scroll-smooth selection:bg-amber-500/30 overflow-x-hidden">
            ...
            {/*  Floating Navbar                                                    */}
            {/* ═══════════════════════════════════════════════════════════════ */}
            <nav className={`fixed top-0 inset-x-0 z-50 transition duration-300 ${scrolled ? 'py-2 md:py-4' : 'py-3 md:py-6'}`}>
            ...
            <section id="hero" className="relative pt-28 pb-16 sm:pt-40 sm:pb-20 lg:pt-52 lg:pb-32 overflow-hidden scroll-mt-20">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-8 sm:gap-16 lg:gap-24">
                    ...
                    <div className="lg:w-1/2 text-center lg:text-left relative z-10 w-full">
                        ...
                        <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-[1.25] sm:leading-[1.1] mb-6 sm:mb-8 tracking-tight
                            text-slate-900 dark:text-white">
                            Làm chủ tài chính,{' '}
                            <span className="block mt-1 sm:mt-2 text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-amber-500">
                                kiến tạo tương lai
                            </span>
                        </h1>
                        ...
                        <div className="mt-8 sm:mt-12 flex flex-wrap items-center justify-center lg:justify-start gap-4 sm:gap-6 text-xs sm:text-sm font-semibold text-slate-500 dark:text-slate-400">
                            <div className="flex items-center gap-2 shrink-0"><ShieldCheck size={18} className="text-emerald-500"/> Bảo mật 256-bit</div>
                            <div className="flex items-center gap-2 shrink-0"><Zap size={18} className="text-amber-500"/> Tích hợp AI</div>
                        </div>
                    </div>
                        ...
                        <div className="relative z-10 rounded-[2rem] sm:rounded-[2.5rem] border border-white/40 dark:border-white/10
                            ...
                            <div className="absolute -top-8 -left-8 lg:-left-12 backdrop-blur-2xl bg-white/95 dark:bg-[#1E293B]/95
                                ...
                                <div className="flex items-center gap-3 sm:gap-4">
                                    ...
                                    <div>
                                        <p className="text-[9px] sm:text-[11px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-widest mb-0.5 sm:mb-1">Thu Nhập Tháng</p>
                                        <p className="text-lg sm:text-2xl font-black text-slate-900 dark:text-white">+85.500.000 VND</p>
                                    </div>
                                </div>
                            </div>
            ...
            {/*  Features Section                                                    */}
            {/* ═══════════════════════════════════════════════════════════════ */}
            <section id="features" className="py-16 sm:py-24 lg:py-32 scroll-mt-20 relative">
                ...
                <div className="max-w-7xl mx-auto px-4 lg:px-8 relative z-10">
                    <div className="text-center mb-10 sm:mb-20">
                        <span className="inline-block px-4 py-2 mb-4 sm:mb-6 rounded-full bg-violet-100 dark:bg-violet-500/10 text-violet-700 dark:text-violet-400 text-xs font-bold uppercase tracking-widest">
                            Giải Pháp Toàn Diện
                        </span>
                        <h2 className="text-3xl sm:text-4xl lg:text-6xl font-black text-slate-900 dark:text-white mb-4 sm:mb-6 tracking-tight">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                        {[
                            ...
                            <div key={i} className="group relative p-6 sm:p-8 rounded-[1.5rem] sm:rounded-[2rem] bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10
            ...
            {/*  Goals Section                                                       */}
            {/* ═══════════════════════════════════════════════════════════════ */}
            <section id="goals" className="py-16 sm:py-24 lg:py-32 bg-slate-100/50 dark:bg-slate-900/50 scroll-mt-20 border-y border-slate-200 dark:border-white/5">
                <div className="max-w-7xl mx-auto px-4 lg:px-8">
                    <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 sm:gap-8 mb-10 sm:mb-16 text-left">
                        <div className="max-w-2xl">
                            <span className="inline-block px-4 py-2 mb-4 sm:mb-6 rounded-full bg-amber-100 dark:bg-amber-500/10 text-amber-700 dark:text-amber-400 text-xs font-bold uppercase tracking-widest">
                                Đạt Được Mục Tiêu
                            </span>
                        ...
                        <button onClick={() => navigate('/dashboard')} className="group flex items-center gap-2 font-bold text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300 self-start lg:self-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                        {[
                            ...
                            <div key={i} className="bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-white/10 rounded-[1.5rem] sm:rounded-[2rem] p-6 sm:p-8 hover:shadow-2xl hover:border-slate-300 dark:hover:border-white/20 transition duration-300">
            ...
            <section id="pricing" className="py-16 sm:py-24 lg:py-32 scroll-mt-20 relative">
                <div className="max-w-7xl mx-auto px-4 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto items-center">
                        ...
                        {/* Gói Free */}
                        <div className="bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 lg:p-10 shadow-xl transition transform hover:-translate-y-1">
                            <div className="flex justify-between items-start mb-6">
                        ...
                        {/* Gói Cơ Bản */}
                        <div className="bg-[#8b5cf6] rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 lg:p-10 shadow-2xl shadow-violet-900/30 transition transform hover:-translate-y-1 scale-100 lg:scale-105 z-10 relative">
                            <div className="flex justify-between items-start mb-6">
                        ...
                        {/* Gói Premium */}
                        <div className="bg-[#1a202c] rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 lg:p-10 border border-slate-700 hover:border-slate-600 shadow-xl transition transform hover:-translate-y-1">
                            <div className="flex justify-between items-start mb-6">
            ...
            <section className="py-16 sm:py-24 lg:py-32 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 lg:px-8 text-center relative z-10">
                    <h2 className="text-3xl sm:text-4xl lg:text-6xl font-black text-white mb-6 sm:mb-8 tracking-tight leading-tight">
                        Kiểm soát tiền bạc.<br className="hidden sm:block" />Làm chủ cuộc sống.
                    </h2>
                    <p className="text-base sm:text-lg lg:text-xl text-white/70 mb-8 sm:mb-12 max-w-2xl mx-auto font-medium leading-relaxed">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
                        <button
                            onClick={() => navigate('/signup')}
                            className="w-full sm:w-auto px-8 py-4 sm:px-12 sm:py-5 rounded-2xl font-black text-base sm:text-lg
            ...
            {/*  Footer                                                              */}
            {/* ═══════════════════════════════════════════════════════════════ */}
            <footer className="bg-white dark:bg-[#0A0E1A] pt-16 pb-8 sm:pt-20 sm:pb-10 border-t border-slate-200 dark:border-white/5">
                <div className="max-w-7xl mx-auto px-4 lg:px-8">
